...
from main.common import normalize_imagenet
from transformers import ViTModel

class ViTLarge(nn.Module):
    def __init__(self, c_dim=128, normalize=True, use_linear=True):
        super(ViTLarge, self).__init__()
        self.model = ViTModel.from_pretrained('google/vit-large-patch16-224-in21k', return_dict=True,
...
class ViTLight(nn.Module):
    def __init__(self, c_dim=128, normalize=True, use_linear=True):
        super(ViTLight, self).__init__()
